...
<body style="text-align:center">
    <table border="1" width="100%">
        ...
        <?php
            $habersay = mysqli_num_rows(mysqli_query($baglan,"select id from haber where (durum='aktif')"));
            $sayfasay = ceil($habersay / 2);
            $baslangic = ($sayfa-1)*2;

            $sorgu = mysqli_query($baglan,"select * from haber where (durum='aktif') order by id asc limit $baslangic,2");
